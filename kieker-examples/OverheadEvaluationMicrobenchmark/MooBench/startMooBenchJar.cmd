...
set JAVAARGS_KIEKER_LOGGING_TCP=%JAVAARGS_LTW% ^
	...
	-Dkieker.monitoring.writer=kieker.monitoring.writer.tcp.v1.Tcp1ThreadWriter
rem	-Dkieker.monitoring.writer=kieker.monitoring.writer.tcp.v0.Tcp2ThreadsWriter
