...
package kieker.monitoring.writer.tcp.v0;
 ...
 * @since 1.8
 */
public final class Tcp2ThreadsWriter extends AbstractAsyncWriter {
	private static final String PREFIX = Tcp2ThreadsWriter.class.getName() + ".";
	...
	public Tcp2ThreadsWriter(final Configuration configuration) {
		super(configuration);
