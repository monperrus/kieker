...
@Plugin(description = "A reader which reads records from a TCP port", outputPorts = {
	@OutputPort(name = Tcp1ThreadFactoryReader.OUTPUT_PORT_NAME_RECORDS, eventTypes = { IMonitoringRecord.class }, description = "Output Port of the TCPReader")
}, configuration = {
	@Property(name = Tcp1ThreadFactoryReader.CONFIG_PROPERTY_NAME_PORT1, defaultValue = "10133", description = "The port of the server used for the TCP connection.")
})
public final class Tcp1ThreadFactoryReader extends AbstractReaderPlugin implements ReadListener {
	...
	public Tcp1ThreadFactoryReader(final Configuration configuration, final IProjectContext projectContext) {
